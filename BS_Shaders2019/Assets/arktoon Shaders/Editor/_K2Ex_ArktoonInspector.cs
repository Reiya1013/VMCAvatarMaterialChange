...
// 本Shader及びコードは上記のsynqark様制作のデータを、MIT Licenceに基づき、改造・二次配布しているものです。改造者：空々こん
// K2Ex 3chArktoon Ver.1.10 for ArktoonShader 1.0.2.6


namespace ArktoonShaders
{
    public class K2EX_ArktoonInspector : ShaderGUI
    {
        #region MaterialProperties
        MaterialProperty BaseTexture;
        MaterialProperty BaseColor;
        MaterialProperty ChMask;
        MaterialProperty ChColor1;
        MaterialProperty ChColor2;
        MaterialProperty ChColor3;
        ...
        MaterialProperty GlossBlendCh1;     // K2Ex
        MaterialProperty GlossBlendCh2;     // K2Ex
        MaterialProperty GlossBlendCh3;     // K2Ex
        MaterialProperty GlossPowerCh1;     // K2Ex
        MaterialProperty GlossPowerCh2;     // K2Ex
        MaterialProperty GlossPowerCh3;     // K2Ex
        MaterialProperty GlossColorCh1;    // K2Ex
        MaterialProperty GlossColorCh2;    // K2Ex
        MaterialProperty GlossColorCh3;    // K2Ex
        ...
        MaterialProperty MatcapTexture1ch;  // K2Ex
        MaterialProperty MatcapTexture2ch;  // K2Ex
        MaterialProperty MatcapTexture3ch;  // K2Ex
        MaterialProperty MatcapColor1ch;    // K2Ex
        MaterialProperty MatcapColor2ch;    // K2Ex
        MaterialProperty MatcapColor3ch;    // K2Ex
        ...
        MaterialProperty ReflectionReflectionPower1ch;  // K2Ex
        MaterialProperty ReflectionReflectionPower2ch;  // K2Ex
        MaterialProperty ReflectionReflectionPower3ch;  // K2Ex
        ...
        MaterialProperty RefractionFresnelExpCh1;
        MaterialProperty RefractionFresnelExpCh2;
        MaterialProperty RefractionFresnelExpCh3;
        MaterialProperty RefractionStrengthCh1;
        MaterialProperty RefractionStrengthCh2;
        MaterialProperty RefractionStrengthCh3;
        ...
        MaterialProperty ShadowcapTexture1ch;   // K2Ex
        MaterialProperty ShadowColor1ch;        // K2Ex
        MaterialProperty ShadowcapTexture2ch;   // K2Ex
        MaterialProperty ShadowColor2ch;        // K2Ex
        MaterialProperty ShadowcapTexture3ch;   // K2Ex
        MaterialProperty ShadowColor3ch;        // K2Ex
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
        {
            ...
            ChMask = FindProperty("_ChMaskTex", props, false);//K2EX
            ChColor1 = FindProperty("_ColorC1", props, false);//K2EX
            ChColor2 = FindProperty("_ColorC2", props, false);//K2EX
            ChColor3 = FindProperty("_ColorC3", props, false);//K2EX
            ...
            GlossBlendCh1 = FindProperty("_GlossBlendCh1", props, false);   // K2Ex
            GlossBlendCh2 = FindProperty("_GlossBlendCh2", props, false);   // K2Ex
            GlossBlendCh3 = FindProperty("_GlossBlendCh3", props, false);   // K2Ex
            GlossPowerCh1 = FindProperty("_GlossPowerCh1", props, false);   // K2Ex
            GlossPowerCh2 = FindProperty("_GlossPowerCh2", props, false);   // K2Ex
            GlossPowerCh3 = FindProperty("_GlossPowerCh3", props, false);   // K2Ex
            GlossColorCh1 = FindProperty("_GlossColorCh1", props, false);   // K2Ex
            GlossColorCh2 = FindProperty("_GlossColorCh2", props, false);   // K2Ex
            GlossColorCh3 = FindProperty("_GlossColorCh3", props, false);   // K2Ex
            ...
            MatcapTexture1ch = FindProperty("_MatcapTexture1ch", props, false); // K2Ex
            MatcapColor1ch = FindProperty("_MatcapColor1ch", props, false);     // K2Ex
            MatcapTexture2ch = FindProperty("_MatcapTexture2ch", props, false); // K2Ex
            MatcapColor2ch = FindProperty("_MatcapColor2ch", props, false);     // K2Ex
            MatcapTexture3ch = FindProperty("_MatcapTexture3ch", props, false); // K2Ex
            MatcapColor3ch = FindProperty("_MatcapColor3ch", props, false);     // K2Ex
            ...
            ReflectionReflectionPower1ch = FindProperty("_ReflectionReflectionPower1ch", props, false); // K2Ex
            ReflectionReflectionPower2ch = FindProperty("_ReflectionReflectionPower2ch", props, false); // K2Ex
            ReflectionReflectionPower3ch = FindProperty("_ReflectionReflectionPower3ch", props, false); // K2Ex
            ...
            RefractionFresnelExpCh1 = FindProperty("_RefractionFresnelExpCh1", props, false);
            RefractionFresnelExpCh2 = FindProperty("_RefractionFresnelExpCh2", props, false);
            RefractionFresnelExpCh3 = FindProperty("_RefractionFresnelExpCh3", props, false);
            RefractionStrengthCh1 = FindProperty("_RefractionStrengthCh1", props, false);
            RefractionStrengthCh2 = FindProperty("_RefractionStrengthCh2", props, false);
            RefractionStrengthCh3 = FindProperty("_RefractionStrengthCh3", props, false);
            ...
            ShadowcapTexture1ch = FindProperty("_ShadowcapTexture1ch", props, false);   // K2Ex
            ShadowColor1ch = FindProperty("_ShadowColor1ch", props, false);             // K2Ex
            ShadowcapTexture2ch = FindProperty("_ShadowcapTexture2ch", props, false);   // K2Ex
            ShadowColor2ch = FindProperty("_ShadowColor2ch", props, false);             // K2Ex
            ShadowcapTexture3ch = FindProperty("_ShadowcapTexture3ch", props, false);   // K2Ex
            ShadowColor3ch = FindProperty("_ShadowColor3ch", props, false);             // K2Ex
            ...
            {
                // Common
                UIHelper.ShurikenHeader("Common K2Ex_3ch ver.1.10");
                UIHelper.DrawWithGroup(() => {
					...
					UIHelper.DrawWithGroup(() => {
                        materialEditor.TexturePropertySingleLine(new GUIContent("Ch Mask"), ChMask);
                        materialEditor.TextureScaleOffsetPropertyIndent(ChMask);
                        materialEditor.ColorProperty(ChColor1, "ChColor1(R)");
                        materialEditor.ColorProperty(ChColor2, "ChColor2(G)");
                        materialEditor.ColorProperty(ChColor3, "ChColor3(B)");
					});
                    UIHelper.DrawWithGroup(() => {
                ...
                if(isRefracted){
                    ...
                    UIHelper.DrawWithGroup(() => {
                        ...
                        materialEditor.ShaderProperty(RefractionFresnelExpCh1, "Ch1 Fresnel Exp");
                        materialEditor.ShaderProperty(RefractionStrengthCh1, "    Strength");
                        materialEditor.ShaderProperty(RefractionFresnelExpCh2, "Ch2 Fresnel Exp");
                        materialEditor.ShaderProperty(RefractionStrengthCh2, "    Strength");
                        materialEditor.ShaderProperty(RefractionFresnelExpCh3, "Ch3 Fresnel Exp");
                        materialEditor.ShaderProperty(RefractionStrengthCh3, "    Strength");
                    });
                }
                ...
                if(isEnabledGloss > 0)
                {
                    UIHelper.DrawWithGroup(() => {
                        ...
                        EditorGUILayout.LabelField("Ch1", EditorStyles.boldLabel);
                        EditorGUI.indentLevel ++;
                        materialEditor.ShaderProperty(GlossBlendCh1, "Smoothness");
                        materialEditor.ShaderProperty(GlossPowerCh1, "Metallic");
                        materialEditor.ShaderProperty(GlossColorCh1, "Color");
                        EditorGUI.indentLevel --;
                        EditorGUILayout.LabelField("Ch2", EditorStyles.boldLabel);
                        EditorGUI.indentLevel ++;
                        materialEditor.ShaderProperty(GlossBlendCh2, "Smoothness");
                        materialEditor.ShaderProperty(GlossPowerCh2, "Metallic");
                        materialEditor.ShaderProperty(GlossColorCh2, "Color");
                        EditorGUI.indentLevel --;
                        EditorGUILayout.LabelField("Ch3", EditorStyles.boldLabel);
                        EditorGUI.indentLevel ++;
                        materialEditor.ShaderProperty(GlossBlendCh3, "Smoothness");
                        materialEditor.ShaderProperty(GlossPowerCh3, "Metallic");
                        materialEditor.ShaderProperty(GlossColorCh3, "Color");
                        EditorGUI.indentLevel --;
                    });
                }
                ...
                if(useMatcap != 3) // Not 'Unused'
                {
                    UIHelper.DrawWithGroup(() => {
                        ...
                        UIHelper.DrawWithGroup(() => {
                            materialEditor.TexturePropertySingleLine(new GUIContent("1ch Texture & Color", "Color and Texture"), MatcapTexture1ch, MatcapColor1ch);
                            materialEditor.TextureScaleOffsetPropertyIndent(MatcapTexture);
                        });
                        UIHelper.DrawWithGroup(() => {
                            materialEditor.TexturePropertySingleLine(new GUIContent("2ch Texture & Color", "Color and Texture"), MatcapTexture2ch, MatcapColor2ch);
                            materialEditor.TextureScaleOffsetPropertyIndent(MatcapTexture);
                        });
                        UIHelper.DrawWithGroup(() => {
                            materialEditor.TexturePropertySingleLine(new GUIContent("3ch Texture & Color", "Color and Texture"), MatcapTexture3ch, MatcapColor3ch);
                            materialEditor.TextureScaleOffsetPropertyIndent(MatcapTexture);
                        });
                ...
                if(useReflection > 0)
                {
                    UIHelper.DrawWithGroup(() => {
                        ...
                        UIHelper.DrawWithGroup(() => {
                            ...
                            materialEditor.ShaderProperty(ReflectionReflectionPower1ch, "1ch Smoothness");
                            materialEditor.ShaderProperty(ReflectionReflectionPower2ch, "2ch Smoothness");
                            materialEditor.ShaderProperty(ReflectionReflectionPower3ch, "3ch Smoothness");
                        });
                        UIHelper.DrawWithGroup(() => {
                ...
                if(useShadowCap != 3) // Not 'Unused'
                {
                    UIHelper.DrawWithGroup(() => {
                        ...
                        UIHelper.DrawWithGroup(() => {
                            materialEditor.TexturePropertySingleLine(new GUIContent("1ch Texture & Color", "Color and Texture"), ShadowcapTexture1ch, ShadowColor1ch);
                            materialEditor.TextureScaleOffsetPropertyIndent(MatcapTexture);
                        });
                        UIHelper.DrawWithGroup(() => {
                            materialEditor.TexturePropertySingleLine(new GUIContent("2ch Texture & Color", "Color and Texture"), ShadowcapTexture2ch, ShadowColor2ch);
                            materialEditor.TextureScaleOffsetPropertyIndent(MatcapTexture);
                        });
                        UIHelper.DrawWithGroup(() => {
                            materialEditor.TexturePropertySingleLine(new GUIContent("3ch Texture & Color", "Color and Texture"), ShadowcapTexture3ch, ShadowColor3ch);
                            materialEditor.TextureScaleOffsetPropertyIndent(MatcapTexture);
                        });
