...
void applyDecals(inout float4 albedo, inout float3 decalEmission)
{
    ...
    decalScale = _DecalScale;
        ...
        #endif
        uv = decalUV(_DecalTextureUV, _DecalPosition, _DecalRotation, _DecalRotationSpeed, decalScale, _Decal0Depth);
    ...
    decalEmission += decalColor.rgb * decalColor.a * max(_DecalEmissionStrength + lerp(_AudioLinkDecal0Emission.x, _AudioLinkDecal0Emission.y, poiMods.audioLink[_AudioLinkDecal0EmissionBand]), 0);
        ...
        decalScale = _DecalScale1;
            ...
            #endif
            uv = decalUV(_DecalTexture1UV, _DecalPosition1, _DecalRotation1, _DecalRotationSpeed1, decalScale, _Decal1Depth);
        ...
        decalScale = _DecalScale2;
            ...
            #endif
            uv = decalUV(_DecalTexture2UV, _DecalPosition2, _DecalRotation2, _DecalRotationSpeed2, decalScale, _Decal2Depth);
        ...
        decalScale = _DecalScale3;
            ...
            #endif
            uv = decalUV(_DecalTexture3UV, _DecalPosition3, _DecalRotation3, _DecalRotationSpeed3, decalScale, _Decal3Depth);
