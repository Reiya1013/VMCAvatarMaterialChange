...
Shader "BeatSaber/GamingEffect/_Extra/EmissiveFreak/Fade" {
    Properties
  {
      ...
      [HideInInspector] shader_is_using_thry_editor("", Float)=0
        [HideInInspector] m_mainOptions ("Main", Float) = 0
          ...
          [HideInInspector] m_start_AlphaMask ("AlphaMask", Float) = 0
            // Alpha Mask(Fade)
            _AlphaMask ("AlphaMask", 2D ) = "white" {}
          [HideInInspector] m_end_AlphaMask ("AlphaMask", Float) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            #include "cginc/gesFadeShadowCaster.cginc"
