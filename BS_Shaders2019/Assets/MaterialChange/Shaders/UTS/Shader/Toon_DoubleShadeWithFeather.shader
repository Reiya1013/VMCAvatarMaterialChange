...
Shader "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather" {
    Properties {
...
//ToonCoreStart
		...
		Pass
        {
			...
			#include "./../../OffAlpha/uts2_offAlpha_D.cginc"

            ENDCG
        }

        Pass {
            Name "FORWARD_DELTA_Reiya_DL"
            Tags {
                "LightMode"="ForwardAdd"
            }
		...
		Pass
        {
			...
			#include "./../../OffAlpha/uts2_offAlpha_SH.cginc"
            ENDCG
        }
