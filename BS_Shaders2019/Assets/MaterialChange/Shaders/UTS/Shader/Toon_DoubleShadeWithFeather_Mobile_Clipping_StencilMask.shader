...
Shader "BeatSaber/UnityChanToonShader/Mobile/Toon_DoubleShadeWithFeather_Clipping_StencilMask" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping_StencilMask/OUTLINE"
