...
Shader "BeatSaber/UnityChanToonShader/Mobile/Toon_DoubleShadeWithFeather_TransClipping_StencilMask" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_TransClipping_StencilMask/OUTLINE"
