...
Shader "BeatSaber/UnityChanToonShader/Mobile/Toon_DoubleShadeWithFeather_TransClipping" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_TransClipping/OUTLINE"
