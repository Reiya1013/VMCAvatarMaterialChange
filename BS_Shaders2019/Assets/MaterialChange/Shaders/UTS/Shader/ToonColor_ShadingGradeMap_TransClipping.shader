...
Shader "BeatSaber/UnityChanToonShader/NoOutline/ToonColor_ShadingGradeMap_TransClipping" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap_TransClipping/FORWARD"
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap_TransClipping/FORWARD_DELTA"
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap_TransClipping/SHADOWCASTER"

        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap_TransClipping/AlphaOff_Reiya_BS"
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap_TransClipping/AlphaOff_Reiya_OL"
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap_TransClipping/AlphaOff_Reiya_SH"
