...
Shader "BeatSaber/UnityChanToonShader/NoOutline/ToonColor_ShadingGradeMap" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap/FORWARD"
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap/FORWARD_DELTA"
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap/SHADOWCASTER"

        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap/AlphaOff_Reiya_BS"
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap/AlphaOff_Reiya_OL"
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap/AlphaOff_Reiya_SH"
