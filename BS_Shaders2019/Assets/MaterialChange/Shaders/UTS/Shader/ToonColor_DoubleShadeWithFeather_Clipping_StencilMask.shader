...
Shader "BeatSaber/UnityChanToonShader/NoOutline/ToonColor_DoubleShadeWithFeather_Clipping_StencilMask" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping_StencilMask/FORWARD"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping_StencilMask/FORWARD_DELTA"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping_StencilMask/SHADOWCASTER"

        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping_StencilMask/AlphaOff_Reiya_BS"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping_StencilMask/AlphaOff_Reiya_OL"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping_StencilMask/AlphaOff_Reiya_SH"
    }
