...
Shader "BeatSaber/UnityChanToonShader/NoOutline/ToonColor_DoubleShadeWithFeather_TransClipping_StencilOut" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/FORWARD"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/FORWARD_DELTA"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/SHADOWCASTER"
                
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/AlphaOff_Reiya_BS"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/AlphaOff_Reiya_OL"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/AlphaOff_Reiya_SH"
