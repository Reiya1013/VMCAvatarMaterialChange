...
Shader "BeatSaber/UnityChanToonShader/Mobile/Toon_ShadingGradeMap_TransClipping_StencilMask" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap_TransClipping_StencilMask/OUTLINE"
