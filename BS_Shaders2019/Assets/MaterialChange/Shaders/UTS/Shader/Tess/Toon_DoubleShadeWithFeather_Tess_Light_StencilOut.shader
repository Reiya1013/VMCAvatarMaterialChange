...
Shader "BeatSaber/UnityChanToonShader/Tessellation/Light/Toon_DoubleShadeWithFeather_StencilOut" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_StencilOut/OUTLINE"
