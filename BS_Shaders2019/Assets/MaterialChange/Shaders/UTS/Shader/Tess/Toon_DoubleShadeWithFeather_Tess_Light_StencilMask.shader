...
Shader "BeatSaber/UnityChanToonShader/Tessellation/Light/Toon_DoubleShadeWithFeather_StencilMask" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_StencilMask/OUTLINE"
