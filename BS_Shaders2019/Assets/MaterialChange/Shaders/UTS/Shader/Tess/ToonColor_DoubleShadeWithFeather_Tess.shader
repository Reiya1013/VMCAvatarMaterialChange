...
Shader "BeatSaber/UnityChanToonShader/Tessellation/NoOutline/ToonColor_DoubleShadeWithFeather" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather/FORWARD"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather/FORWARD_DELTA"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather/SHADOWCASTER"

        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather/AlphaOff_Reiya_BS"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather/AlphaOff_Reiya_OL"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather/AlphaOff_Reiya_SH"
    }
