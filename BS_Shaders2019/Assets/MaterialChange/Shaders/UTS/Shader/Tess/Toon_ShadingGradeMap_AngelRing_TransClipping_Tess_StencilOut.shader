...
Shader "BeatSaber/UnityChanToonShader/Tessellation/AngelRing/Toon_ShadingGradeMap_TransClipping_StencilOut" {
    Properties {
...
//ToonCoreStart
		...
		Pass
        {
            ...
            //
            //Tessellation
			#include "./../../../OffAlpha/uts2_offAlpha_S_Tess.cginc"
        ...
        Pass {
			...
			#include "./../../../OffAlpha/uts2_offAlpha_OL_Tess.cginc"
            ENDCG
        }
		...
		Pass
        {
            ...
            //Tessellation
			#include "./../../../OffAlpha/uts2_offAlpha_SH_Tess.cginc"
