...
Shader "BeatSaber/UnityChanToonShader/Tessellation/Light/Toon_ShadingGradeMap" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_ShadingGradeMap/OUTLINE"
