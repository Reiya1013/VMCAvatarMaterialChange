...
Shader "BeatSaber/UnityChanToonShader/Mobile/Toon_DoubleShadeWithFeather_StencilMask" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_StencilMask/OUTLINE"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_StencilMask/FORWARD"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_StencilMask/SHADOWCASTER"

        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_StencilMask/AlphaOff_Reiya_BS"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_StencilMask/AlphaOff_Reiya_OL"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_StencilMask/AlphaOff_Reiya_SH"
