...
Shader "BeatSaber/UnityChanToonShader/NoOutline/ToonColor_DoubleShadeWithFeather" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather/FORWARD"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather/FORWARD_DELTA"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather/SHADOWCASTER"

        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather/AlphaOff_Reiya_BS"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather/AlphaOff_Reiya_OL"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather/AlphaOff_Reiya_SH"
