...
Shader "BeatSaber/Sunao Shader/Transparent Sparkles" {
	...
	SubShader {
		...
		Pass
        {
			...
			#include "./../../OffAlpha/sunao_offAlpha_Lame.cginc"
		...
		Pass
        {
			...
			#include "./../../OffAlpha/sunao_offAlpha_Lame_OL.cginc"
		...
		Pass {
			...
			#include "./../../OffAlpha/sunao_offAlpha_Lame_SC.cginc"
	...
	CustomEditor "SunaoShader_Lame.GUI"
}
