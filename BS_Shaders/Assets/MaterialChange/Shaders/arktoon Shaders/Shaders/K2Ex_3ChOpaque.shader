...
Shader "BeatSaber/arktoon/_K2Extra/3ChOpaque" {
    Properties {
        // Double Sided
        ...
        _ChMaskTex ("[Common] ChMask Texture", 2D) = "white" {} // K2Ex
        _ColorC1 ("[Common] 1Ch Color", Color) = (1,1,1,1) // K2Ex
        _ColorC2 ("[Common] 2Ch Color", Color) = (1,1,1,1) // K2Ex
        _ColorC3 ("[Common] 3Ch Color", Color) = (1,1,1,1) // K2Ex
