...
Shader "BeatSaber/UnityChanToonShader/Mobile/AngelRing/Toon_ShadingGradeMap" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/AngelRing/Toon_ShadingGradeMap/OUTLINE"
