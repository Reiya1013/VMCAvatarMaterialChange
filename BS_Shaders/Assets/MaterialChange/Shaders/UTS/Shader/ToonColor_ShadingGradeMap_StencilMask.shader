...
Shader "BeatSaber/UnityChanToonShader/NoOutline/ToonColor_ShadingGradeMap_StencilMask" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap_StencilMask/FORWARD"
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap_StencilMask/FORWARD_DELTA"
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap_StencilMask/SHADOWCASTER"

        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap_StencilMask/AlphaOff_Reiya_BS"
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap_StencilMask/AlphaOff_Reiya_OL"
        UsePass "BeatSaber/UnityChanToonShader/Toon_ShadingGradeMap_StencilMask/AlphaOff_Reiya_SH"
