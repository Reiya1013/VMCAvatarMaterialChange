...
Shader "BeatSaber/UnityChanToonShader/Tessellation/NoOutline/ToonColor_DoubleShadeWithFeather_StencilMask" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_StencilMask/FORWARD"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_StencilMask/FORWARD_DELTA"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_StencilMask/SHADOWCASTER"

        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_StencilMask/AlphaOff_Reiya_BS"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_StencilMask/AlphaOff_Reiya_OL"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_StencilMask/AlphaOff_Reiya_SH"
