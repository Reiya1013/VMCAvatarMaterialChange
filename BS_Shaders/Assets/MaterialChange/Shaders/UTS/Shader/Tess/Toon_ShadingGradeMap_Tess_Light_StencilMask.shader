...
Shader "BeatSaber/UnityChanToonShader/Tessellation/Light/Toon_ShadingGradeMap_StencilMask" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_ShadingGradeMap_StencilMask/OUTLINE"
