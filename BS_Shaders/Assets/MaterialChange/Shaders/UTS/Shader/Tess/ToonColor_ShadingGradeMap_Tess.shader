...
Shader "BeatSaber/UnityChanToonShader/Tessellation/NoOutline/ToonColor_ShadingGradeMap" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_ShadingGradeMap/FORWARD"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_ShadingGradeMap/FORWARD_DELTA"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_ShadingGradeMap/SHADOWCASTER"

        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_ShadingGradeMap/AlphaOff_Reiya_BS"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_ShadingGradeMap/AlphaOff_Reiya_OL"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_ShadingGradeMap/AlphaOff_Reiya_SH"
