...
Shader "BeatSaber/UnityChanToonShader/Tessellation/NoOutline/ToonColor_DoubleShadeWithFeather_TransClipping_StencilOut" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/FORWARD"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/FORWARD_DELTA"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/SHADOWCASTER"

        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/AlphaOff_Reiya_BS"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/AlphaOff_Reiya_OL"
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/AlphaOff_Reiya_SH"
    }
