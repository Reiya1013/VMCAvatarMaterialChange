...
Shader "BeatSaber/UnityChanToonShader/Tessellation/Light/AngelRing/Toon_ShadingGradeMap_StencilOut" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/AngelRing/Toon_ShadingGradeMap_StencilOut/OUTLINE"
