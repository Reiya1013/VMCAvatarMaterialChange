...
Shader "BeatSaber/UnityChanToonShader/Tessellation/Light/Toon_DoubleShadeWithFeather" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather/OUTLINE"
