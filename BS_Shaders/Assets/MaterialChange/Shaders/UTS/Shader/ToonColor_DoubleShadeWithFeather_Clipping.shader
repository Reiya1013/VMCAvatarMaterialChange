...
Shader "BeatSaber/UnityChanToonShader/NoOutline/ToonColor_DoubleShadeWithFeather_Clipping" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping/FORWARD"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping/FORWARD_DELTA"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping/SHADOWCASTER"

        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping/AlphaOff_Reiya_BS"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping/AlphaOff_Reiya_OL"
        UsePass "BeatSaber/UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping/AlphaOff_Reiya_SH"
    }
