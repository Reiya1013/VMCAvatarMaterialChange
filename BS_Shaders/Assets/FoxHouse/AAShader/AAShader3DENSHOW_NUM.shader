...
Shader "Toon/AAShader3DENSHOW_NUM" {
	Properties{
		...
		_NumR("R(shadow)", Range(0,1)) = 0.5 //陰の位置
		_NumG("G(gross)", Range(0,1)) = 0.5 //光沢
		_NumBB("B(BEKKAKU)", Range(0,1)) = 0.5 //BEKKAKU
		_NumBT("B(tights)", Range(0,1)) = 0.5 //tights
		_NumA("A(emission)", Range(0,1)) = 1 //tights
