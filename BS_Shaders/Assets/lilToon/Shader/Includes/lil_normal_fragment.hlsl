...
float4 frag(v2f input, float facing : VFACE) : SV_Target
{
    ...
    float emiAlpha1=0;  //addReiya 2021/09/29
    float emiAlpha2=0;  //addReiya 2021/09/29
        ...
        // Glitter
            ...
            // Emission
                ...
                if(_UseEmission)
                {
                    ...
                    emiAlpha1 = _EmissionBlend * lilCalcBlink(_EmissionBlink) * emissionColor.a * emissionColor.rgb;  //addReiya 2021/09/29
                }
            #endif
            ...
            // Emission2nd
                ...
                if(_UseEmission2nd)
                {
                    ...
                    emiAlpha2 = _Emission2ndBlend * lilCalcBlink(_Emission2ndBlink) * emission2ndColor.a * emission2ndColor.rgb;  //addReiya 2021/09/29
                }
            #endif
    ...
    // BeatSaber‘Î‰ž
        ...
        int updateAupha = 0;
        #if defined(LIL_FEATURE_AUDIOLINK)
            float adaudiolink = audioLinkValue;
            updateAupha += adaudiolink;
            addCnt +=1;
        #endif
        #ifndef LIL_PASS_FORWARDADD
            #if defined(LIL_FEATURE_EMISSION_1ST)
                updateAupha += emiAlpha1;
                addCnt +=1;
            #endif
            #if defined(LIL_FEATURE_EMISSION_2ND)
                updateAupha += emiAlpha2;
                addCnt +=1;
            #endif
        #endif
        #if (i > 0)
            col.a = (updateAupha / addCnt);
         #endif
    #endif
